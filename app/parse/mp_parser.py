...
class MPParser(object):
    ...
    def parse(self):
        ...
        :return: list - [<string_source_department_label>,
        ...
        for mp_row in self.mp_reader:
            ...
            try:
                for src_opcode in mapper[mp_row[0].strip()]:
                    dest = mp_row[8]
                    if mp_row[8] == 'MMK' or mp_row[8].lower() == 'etv':
                        dest = "MKO"
                    elif mp_row[8].lower() == 'ladu':
                        dest = "LADU"
                    elif mp_row[8] == 'TOR' or mp_row[8].lower() == 'lme':
                        dest = "TLO"
                    elif mp_row[8] == 'LÍV':
                        dest = "LOV"
                    data[(src_opcode.strip(), mp_row[0].strip())][1] = dest
            except KeyError:
                pass
            ...
            for opcode in next_opcodes:
                if mp_row[0][0] == "W":
                    src = "DUMMY"
                elif mp_row[0][0] == "I" or mp_row[8].lower() == 'ladu':
                    src = "LADU"
                elif mp_row[8] == 'MMK' or mp_row[8].lower() == 'etv':
                    src = "MKO"
                elif mp_row[8] == 'TOR' or mp_row[8].lower() == 'lme':
                    src = "TLO"
                elif mp_row[8] == 'LÍV':
